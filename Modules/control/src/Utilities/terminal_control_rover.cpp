...
int main(int argc, char **argv)
{
    ...
    while(ros::ok())
    {
        ...
        cout << "Input the Mode: 0 for Idle, 1 for Takeoff, 2 for Hold, 3 for Land, 4 for Move, 5 for Disarm, 6 for Flight_Track, 7 for User_Mode2"<<endl;
        ...
        switch (Control_Mode)
        {
            ...
            case prometheus_msgs::ControlCommand::flight_track:
                Command_Now.header.stamp = ros::Time::now();
                Command_Now.Mode = prometheus_msgs::ControlCommand::flight_track;
                Command_Now.Command_ID = Command_Now.Command_ID + 1;
                Command_Now.source = NODE_NAME;
